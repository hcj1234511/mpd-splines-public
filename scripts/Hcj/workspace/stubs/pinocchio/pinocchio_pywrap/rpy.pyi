...
__all__: list[str] = ['computeRpyJacobian', 'computeRpyJacobianInverse', 'computeRpyJacobianTimeDerivative', 'matrixToRpy', 'npToTTuple', 'npToTuple', 'rotate', 'rpyToMatrix']
def computeRpyJacobian(*args, **kwargs):
    """
    
    computeRpyJacobian( (numpy.ndarray)rpy [, (ReferenceFrame)reference_frame]) -> numpy.ndarray :
...
def computeRpyJacobianInverse(*args, **kwargs):
    ...
    computeRpyJacobianInverse( (numpy.ndarray)rpy [, (ReferenceFrame)reference_frame]) -> numpy.ndarray :
...
def computeRpyJacobianTimeDerivative(*args, **kwargs):
    ...
    computeRpyJacobianTimeDerivative( (numpy.ndarray)rpy, (numpy.ndarray)rpydot [, (ReferenceFrame)reference_frame]) -> numpy.ndarray :
...
def rotate(*args, **kwargs):
    ...
    rotate( (str)axis, (float)ang) -> numpy.ndarray :
